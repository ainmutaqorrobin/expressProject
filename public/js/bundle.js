  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? '/api/v1/users/updatePassword' : '/api/v1/users/updateUserSelf';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripePromise = (0, _stripeJs.loadStripe)('pk_test_51Pb5cTJ4tUJffrKJQFNtclmfogx4sljslOxfJ4DQXUcII72HEr9OF6wk38VaJaIzlmVZeFqw5t0goxQxmboYeZC600n8zYE75H');
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            console.log(form);
            _context.next = 8;
            return (0, _updateProfile.updateData)(form, 'data');
          case 8:
          case "end":
            return _context.stop();
        }
